        ...
        <div className="flex gap-4">
          ...
          {item.image_url && (
            <div className="w-28 h-28 rounded-xl overflow-hidden flex-shrink-0 shadow-lg relative">
              <SmartImage src={getOptimizedImageUrl(item.image_url, IMAGE_SIZES.card.width, IMAGE_SIZES.card.quality, IMAGE_SIZES.card.height)} alt={item.name} className="w-full h-full object-cover" loading="lazy" decoding="async" />
              <div
