    ...
    <div className="space-y-5">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-2">
          ...
          <h3 className="text-[#f1f5f9] font-bold text-sm">Operaciones del día</h3>
        ...
        <div className="flex items-center gap-2">
          ...
          <button onClick={fetchRiders} className="p-1.5 rounded-lg bg-[#1e293b] text-[#94a3b8] hover:text-[#f1f5f9] transition-colors">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
        {[
          ...
          >
            ...
            <p className="text-xl font-black text-[#f1f5f9]">{kpi.value}</p>
          </div>
        ))}
      </div>
      ...
      <div>
        <div className="flex items-center gap-2 mb-3">
          ...
          <h4 className="text-[#94a3b8] text-xs font-bold uppercase tracking-wide">
            Riders activos ({riders.length})
          </h4>
        </div>
        {riders.length === 0 ? (
          <p className="text-[#64748b] text-xs text-center py-4">Sin riders activos</p>
        ) : (
                ...
                >
                  <div className="flex items-center gap-2.5">
                    <div className="relative">
                      <div className="w-8 h-8 rounded-full bg-[#1e293b] flex items-center justify-center text-base">
                  ...
                  {rider.currentOrder?.delivery_eta_minutes && (
                    <div className="text-right">
                      ...
                      <p className="text-[#64748b] text-[10px]">ETA</p>
                    </div>
                  )}
                </div>
              );
      ...
      <div>
        ...
        {activeOrders.length === 0 ? (
          <p className="text-[#64748b] text-xs text-center py-4">Sin pedidos activos</p>
        ) : (
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <div className="flex items-center gap-2 mt-0.5">
                        ...
                        {rider && (
                          <span className="text-[#64748b] text-[10px]">{rider.name}</span>
                        )}
                      </div>
                    </div>
                  </div>
                  <div className="text-right shrink-0">
                    <p className={`text-xs font-bold ${isLate ? 'text-red-400' : 'text-[#94a3b8]'}`}>
                      {mins} min
                    </p>
      ...
      {totalDistKm > 0 && (
        ...
        >
          <div className="flex items-center gap-2">
            ...
            <span className="text-[#94a3b8] text-xs">Distancia total recorrida hoy</span>
          </div>
