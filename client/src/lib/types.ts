...
export const TENANT_HERO_IMAGES: Record<string, string> = {
  'flor-y-sal': 'https://images.unsplash.com/photo-1414235077428-338989a2e8c0?w=800&q=85',
  'the-patty-factory': 'https://images.unsplash.com/photo-1568901346375-23c9450c58cd?w=800&q=85',
